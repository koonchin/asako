      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          ...
          <div className="flex gap-4">
             <button className="px-6 py-2 border border-gray-200 text-[10px] font-bold uppercase tracking-widest hover:bg-white transition-colors">Filters</button>
             <button className="px-6 py-2 border border-gray-200 text-[10px] font-bold uppercase tracking-widest hover:bg-white transition-colors">Sort By: Price</button>
          </div>
        </div>
